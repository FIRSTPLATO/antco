  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="rute.php">Rute Pendistribusian</a></li>
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-body">
			<h3><p align="center" class="text-primary"><!--img src="ui/img/logo.png" class="img-responsive" /--><?php echo $_SESSION['welcome'];?></p></h3>
		  </div>
