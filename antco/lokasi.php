  ...
  <body>
	...
	<div class="container">
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="lokasi.php">Lokasi Alfamidi</a></li>
	  ...
	  <br><br><br>
		<ol class="breadcrumb">
		  <li><a href="index.php">Home</a></li>
		  <li class="active">Lokasi Alfamidi</li>
		</ol>
	  <div id="page-wrapper">
      <div class="row">
      <div class="col-lg-12">
	  <div class="panel panel-primary">
		  ...
		  <div class="panel-heading">Lokasi Alfamidi</div>
		  ...
		  <div class="panel-body table-responsive">
			...
			<thead>
				<tr>
					...
					<th>Alamat</th>
					<th>Latitude</th>
					<th>Longitude</th>ucwords($row["alamat"]).'</td>';
													echo '<td>'.$row["lat"].'</td>';
													echo '<td>'.$row["lng"].'</td>';
